...
# __all__ = ['MLFlowLogger', 'OutputHandler']
...
#             from ignite.contrib.handlers.mlfow_logger import *
...
#     and validation.
#     This class requires `mlflow <https://github.com/mlflow/>`_ package to be installed:
